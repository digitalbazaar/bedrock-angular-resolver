...
describe('routeResolverProvider', function() {
  ...
  it('should invoke global route resolve functions in the proper order', function(done) {
    // create fake route
    var routeOptions = {};
  ...
  it('should invoke global and local route resolve functions in the proper order', function(done) {
    // create fake route
    var routeOptions = {
      resolve: {
        _test: function() {
